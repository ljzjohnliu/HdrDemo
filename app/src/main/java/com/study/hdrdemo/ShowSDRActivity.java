...
public class ShowSDRActivity extends BaseActivity {
...
//        loadHdrBySystemApi2(draweeViewImg2, filePath, true);
        ...
        playBtn.setOnClickListener(v -> {
            Log.d(TAG, "playBtn: I will click!!!!");
            startActivity(new Intent(this, ShowHDRActivity.class));
        });

        pauseBtn.setOnClickListener(v -> {
            Log.d(TAG, "stopBtn: I will click!!!!");
            enableHdr();
            ...
            DraweeController controller = Fresco.newDraweeControllerBuilder()
                    ...
                    .setControllerListener(new BaseControllerListener<ImageInfo>() {
                        ...
                        public void onFinalImageSet(String id, @Nullable ImageInfo imageInfo, @Nullable Animatable animatable) {
                            Log.d(TAG, "onFinalImageSet: imageInfo = " + imageInfo);
...
//                                                newBitmap.setColorSpace(ColorSpace.get(ColorSpace.Named.BT2020_PQ));
                                        ...
                                        Toast.makeText(ShowSDRActivity.this, "显示带增益的bitmap", Toast.LENGTH_SHORT).show();
...
//                bitmap = BitmapFactory.decodeFile(file.getAbsolutePath());
            ...
            if (bitmap != null) {
                ...
                Log.e(TAG, "loadNormalBySystemApi: ---333---bitmap getConfig = " + bitmap.getConfig()
                        + ", hasGainmap = " + GainmapReflector.hasGainmap(bitmap) + ", getColorSpace = " + bitmap.getColorSpace());
            }
            if (GainmapReflector.hasGainmap(bitmap)) {
                final Object gainmap = GainmapReflector.getGainmap(bitmap);
                Log.e(TAG, "loadNormalBySystemApi: ---444---gainmap = " + gainmap);
...
//                }, 5000);
            ...
            simpleDraweeView.setColorFilter(null);
            simpleDraweeView.setImageBitmap(bitmap);
        }
    }
