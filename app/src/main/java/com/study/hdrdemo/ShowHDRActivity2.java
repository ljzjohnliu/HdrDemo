...
import com.study.hdrdemo.utils.LayoutParamsReflector;
import com.study.hdrdemo.utils.TestFile;
import com.study.hdrdemo.view.PictureTextureView;
...
public class ShowHDRActivity2 extends BaseActivity {
    private static final String TAG = "debug_hdr";
  TextView tipsTv;

    SimpleDraweeView draweeViewImg;
    ImageView imgView;
    PictureTextureView surfaceView;
...
//        setContentView(R.layout.activity_show_bug);
        setContentView(R.layout.activity_show_hdr2);
...
//            }
            ...
            Log.d(TAG, "onCreate: getSystemAvailableFeatures length = " + featureInfos.length);
//            for (FeatureInfo featureInfo:featureInfos) {
//                Log.d(TAG, "onCreate: getSystemAvailableFeatures  = " + featureInfo.name);
//                if (featureInfo.name.contains("hdr")) {
//                    Log.d(TAG, "onCreate: $$$$$$$$$$  = " + featureInfo.name);
//                }
//            }
            // 检查设备是否支持 HDR10
//            boolean isHdr10Supported = getPackageManager().hasSystemFeature(PackageManager.FEATURE_HDR10);
//            // 检查设备是否支持杜比视界
//            boolean isDolbyVisionSupported = getPackageManager().hasSystemFeature(PackageManager.FEATURE_DOLBY_VISION);
        }
...
//                                                newBitmap.setColorSpace(ColorSpace.get(ColorSpace.Named.BT2020_PQ));
                                        ...
                                        Toast.makeText(ShowHDRActivity2.this, "显示带增益的bitmap", Toast.LENGTH_SHORT).show();
...
//                }, 5000);
    ...
    private void loadHdrBySystemApi(ImageView imgView, String filePath, boolean useInputStream) {
        File file = new File(Uri.parse(filePath).getPath());
